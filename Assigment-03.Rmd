...
As shown in Figure 1, the MM genotype has a tight clustering and many plates. The mm genotype has a similar tight clustering, with few plates. The Mm genotype more closely mirrors the MM genotype, but has a significant spread of plate frequencies. These facts are reflected in the medians and standard deviations given in Table 1.
